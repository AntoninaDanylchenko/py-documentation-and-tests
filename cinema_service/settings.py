...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        "API for managing cinema data, including movies, cinema halls, "
        "genres, actors, movie sessions and reservations. "
        "Supports authentication, filtering and CRUD operations."
    ),
    "VERSION": "1.0.0",
